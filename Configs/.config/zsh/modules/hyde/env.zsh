...
# History file for shells (generic fallback)
HISTFILE="${HISTFILE:-$HOME/.history}"

HYDE_ZSH_DEFER="Unset this variable in $ZDOTDIR/user.zsh to disable HyDE's deferred Zsh loading."
HYDE_ZSH_PROMPT="Unset this variable in $ZDOTDIR/user.zsh to disable HyDE's prompt loading."
...
export PATH \
  ...
  LESSHISTFILE PARALLEL_HOME SCREENRC HISTFILE HYDE_ZSH_DEFER
